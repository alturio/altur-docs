...
The `on_call_end` webhook is triggered at the conclusion of a call in the Altur platform. This webhook provides detailed information about the call, the agent involved, and the end user. Use this webhook to keep your backend or CRM updated with the latest call data.
