...
<Warning>
  Invalid phone numbers or contacts that already exist in the campaign will be skipped automatically.
</Warning>
...
- Validate your contact data before uploading it.
 ...
 \<Note\> If your CSV contains more than 10,000 contacts, we recommend splitting it into smaller files to ensure smooth processing. \</Note\> 
...
This helps you analyze campaign performance or create follow-up lists.
