...
- `ended_by`: Quién finalizó la llamada (`agent`, `user` o `system`). Vacío si la llamada nunca conectó.
- `ended_reason`: Motivo breve por el que finalizó la llamada. Vacío si no está disponible.
